...
// Backend metrics
var (
	TicketsAssigned = stats.Int64("openmatch.dev/backend/tickets_assigned", "Number of tickets assigned per request", stats.UnitDimensionless)
	TicketsReleased = stats.Int64("openmatch.dev/backend/tickets_released", "Number of tickets released per request", stats.UnitDimensionless)
)
